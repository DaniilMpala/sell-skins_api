...
export class CreateTransactionDto {
  ...
  meta?: any;
  tradeurl: string;
  cancelAfterSeconds?: number; //Через сколько в секундах отменить трейд, если не передать параметр, то автоотмена сработает через 20минут после создания транзакции
};
```
