...
```ts
{
  ...
  "tradeurl": "Trade URL",
  "meta": {}, (опционально, можно передать люборй объект с данными, например внутрь можно добавить externalId или другие параметры ваши, он будет возвращен в коллбеке)
  "items": [
    {
      "appid": "App ID",
      "contextid": "Context ID",
